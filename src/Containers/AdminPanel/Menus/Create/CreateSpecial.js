...
class CreateSpecial extends Component {
    ...
    componentDidMount() {
        axios.get("https://custom-menu-generator.firebaseio.com/SpecialMenus/.json").then(res => {
            let menuno = null
    ...
    createMenu = () => {
        ...
        menu.items = items
        axios.post("https://custom-menu-generator.firebaseio.com/SpecialMenus/.json?auth="+this.props.token, menu).then(res => {
...
export default connect(mapStatetoProps)(withRouter(CreateSpecial));
...
class Edit extends Component
{
    ...
    componentDidMount()
    {
        ...
        axios.get("https://custom-menu-generator.firebaseio.com/Menus/"+menu+"/.json").then(res=>
        {
    ...
    updateMenu=()=>
    {
        ...
        menu.items = items
        axios.put("https://custom-menu-generator.firebaseio.com/Menus/"+this.state.foldername+"/.json?auth="+this.props.token,menu).then(res=>
        {
...
export default connect(mapStatetoProps)(withRouter(withErrorHandler(Edit,axios)));